...
public class Realty {
	...
	private RealtyDefinition definition;
	
	public Realty() {
		super();
	}
	
	public Realty(Long no, String title, LocalDateTime publishedDate, User user, 
			RealtyType status, String province, String district, DwellingType type, RealtyDefinition definition) {
		super();
		this.no = no;
		this.title = title;
	...
	public RealtyDefinition getDefinition() {
		return definition;
	}

	public void setDefinition(RealtyDefinition definition) {
		this.definition = definition;
	}
